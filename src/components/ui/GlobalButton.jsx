const buttonVariants = {
  ...
  modalTwo: 'bg-epaColor1 rounded-md hover:bg-blue-100 hover:text-epaColor1 transform transition duration-300 ease-in-out',
  modalThree: 'bg-red-700 rounded-md hover:bg-red-200 hover:text-red-600 transform transition duration-300 ease-in-out',
